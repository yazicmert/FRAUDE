...
const GUIDE: Record<'tr' | 'en', GuideContent> = {
  tr: {
    ...
    modules: [
      ...
      { code: 'FR', name: 'Forum', tag: 'Topluluk', desc: 'Kullanıcıların ortak alanı: konu aç, yanıtla, beğen. Metinde etiketlediğin hisse, konuyu o hissenin sayfasında da gösterir.', items: ['Gönderiler Supabase\'de ortaktır: birinin yazdığı konu diğer kullanıcıların uygulamasında da görünür', 'Etiketlemek için gövdeye $THYAO yazman yeter; "Hisse etiketle" kutusundan BIST evreninden de seçebilirsin', 'Etiketin karşılığı: aynı gönderi o hissenin sayfasındaki Forum bölümünde listelenir — hisse sayfasından yazınca etiket kendiliğinden eklenir', 'Tek seviye iş parçacığı: konu + yanıtlar, beğeni, kendi gönderini düzenleme ve silme', 'En çok konuşulanlar paneli son bir haftanın etiket sayımından; tıklayınca akış o hisseye iner', 'Yeni gönderiler canlı düşer ve listeye tek tek işlenir: okuduğun yer kaybolmaz, başkasının beğenisi anında görünür', 'Kartın ⋯ menüsünden bildir (spam/hakaret/yanlış bilgi) ya da kullanıcıyı engelle; engellediklerin sağ panelden geri alınır', 'Üç ayrı kişi bildirince gönderi moderatör bakana kadar kendiliğinden gizlenir — gövdesi durur, karar geri alınabilir', 'Moderatörler sağ paneldeki kuyruktan gizler, geri alır ya da bildirimleri temizler', 'Yazar adı sunucuda oturumdan yazılır, istemciden gelen ad yok sayılır; dakikada 8, günde 100 gönderi sınırı vardır'] },
