...
const GUIDE: Record<'tr' | 'en', GuideContent> = {
  ...
  en: {
    ...
    modules: [
      ...
      { code: 'AR', name: 'Research Reports', tag: 'Reports', desc: 'Brokerage and bank research reports plus analyst consensus — in its own module and on the stock page.', items: ['5 broker feeds: İş Yatırım, Vakıf Yatırım, Halk Yatırım, Marbaş Menkul, A1 Capital', 'Broker / type (company, sector, strategy, bulletin) filters and title-ticker-analyst search', 'Rating (Buy/Hold/Outperform) and target price extracted from the report; one-click PDF access', 'Consensus tab: number of covering institutions, BUY/HOLD/SELL split, average target and upside', 'Foreign banks\' BIST reports are subscription-gated; their coverage is reached through consensus aggregates', 'Per-ticker tag feed for a company\'s full report history (İş Yatırım)'] },
