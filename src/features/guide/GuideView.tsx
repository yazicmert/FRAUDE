...
const GUIDE: Record<'tr' | 'en', GuideContent> = {
  tr: {
    ...
    modules: [
      { code: 'DB', name: 'Pano', tag: 'Ana ekran', desc: 'Piyasanın günlük özeti ve karar destek modülleri.', items: ['Günlük Piyasa Bülteni: genişlik, BIST 100, XHARZ, lider/zayıf', 'Bülten şeridindeki her satır gideceği yeri açar: BIST 100 → endeks sekmesi, günün lideri → hisse sekmesi, aşırı satım → tarayıcı (satırlarıyla), bekleyen bildirim → KAP akışı', 'Model Portföy: değer + kalite + momentum puanları', 'Bilanço Analizi: F/K, PD/DD, ROE, ROA, marj, büyüme', 'Filtreli Analiz: çoklu eşik taraması'] },
      ...
      { code: 'IX', name: 'Endeks Görünümü', tag: 'Index', desc: 'Endeks seviyesi, dönemsel getiriler ve bileşen evreni.', items: ['86 BIST endeksinin tamamı aranabilir ve açılabilir (XU100, XU500, XUMAL, XUHIZ, katılım, temettü, GMYO ve şehir endeksleri)', 'Dönemsel getiri şeridi: gün, hafta, ay, 6 ay, yıl, 5 yıl, tüm zamanlar', 'Tarihçe her aralıkta Borsa İstanbul\'un resmî serisinden — XU100 1986\'ya kadar', 'Genç endekslerde ulaşılamayan dönem uydurulmaz, "—" gösterilir', 'Endeks bileşen listesi, ısı haritası ve endekse giriş/çıkış rozeti', 'Yeni halka arzlar IPO etiketiyle'] },
  ...
  en: {
    ...
    modules: [
      { code: 'DB', name: 'Dashboard', tag: 'Home', desc: 'Daily market summary and decision-support modules.', items: ['Daily Market Bulletin: breadth, BIST 100, XHARZ, leaders/laggards', 'Every line in the bulletin strip opens where it points: BIST 100 → index tab, day\'s leader → ticker tab, oversold → screener (with its rows), pending disclosures → KAP feed', 'Model Portfolio: value + quality + momentum scores', 'Financial Analysis: P/E, P/B, ROE, ROA, margin, growth', 'Filtered Analysis: multi-threshold screen'] },
      ...
      { code: 'IX', name: 'Index View', tag: 'Index', desc: 'Index level, period returns and constituent universe.', items: ['All 86 BIST indices are searchable and openable (XU100, XU500, XUMAL, XUHIZ, participation, dividend, REIT and city indices)', 'Period return strip: day, week, month, 6 months, year, 5 years, all time', 'History comes from Borsa İstanbul\'s official series at every range — XU100 back to 1986', 'Periods a young index cannot reach are shown as "—", never invented', 'Constituent list, heatmap and index add/remove badge', 'New IPOs tagged IPO'] },
