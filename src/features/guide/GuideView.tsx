...
const GUIDE: Record<'tr' | 'en', GuideContent> = {
  tr: {
    ...
    modules: [
      ...
      { code: 'CA', name: 'Kurumsal Olaylar', tag: 'Corporate', desc: 'Şirket aksiyonları ve halka arz takvimi.', items: ['Temettü kayıtları — KAP kar payı bildirimlerinden: pay grubu bazında brüt/net ve kesinleşen hak kullanım tarihi', 'Kâr payını dövizle açıklayan şirketler ayrı not olarak listelenir; o satırlarda tutar lira değildir ve para birimi rozetiyle işaretlenir', 'Bedelli/bedelsiz sermaye artırımları — SPK bültenleri + KAP bildirimleri', 'Halka arz takvimi ve arşivi; fiyat, lot ve arz büyüklüğü SPK izahname onayından', 'Onay sonrası otomatik takip: katılımcı sayısı, ilk işlem tarihi, pazar ve endeks üyeliği KAP bildirimleri yayımlandıkça kendiliğinden dolar', 'Her satır kaynağını gösterir (SPK bülteni / KAP bildirimi)'] },
