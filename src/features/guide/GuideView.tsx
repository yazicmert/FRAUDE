...
const GUIDE: Record<'tr' | 'en', GuideContent> = {
  tr: {
    ...
    quickSteps: [
      ...
      'Üst çubuktaki takvim düğmesi ekonomik veri takvimini açar. Bir satırı genişletince o veriden etkilenebilecek BIST payları ve dünya enstrümanları gerekçeleriyle etiketlenir; altında o konudaki analiz raporları ve haberler durur, hepsi uygulama içinde açılır.',
    ],
  ...
  en: {
    ...
    quickSteps: [
      ...
      'The calendar button in the top bar opens the economic data calendar. Expanding a row tags the BIST shares and world instruments that release can touch, each with its reason, and lists the research and news on that topic — all of it opens inside the app.',
    ],
