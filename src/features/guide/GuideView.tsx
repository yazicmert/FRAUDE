...
const GUIDE: Record<'tr' | 'en', GuideContent> = {
  tr: {
    ...
    modules: [
      ...
      { code: 'TK', name: 'Hisse Detayı', tag: 'Ticker', desc: 'Tek hissenin tam kartı; aramadan veya tablodan açılır.', items: ['Fiyat, OHLC, hacim, 52 hafta grafiği', 'Temel veriler: F/K, PD/DD, ROE, marj, Net Borç/FAVÖK', 'Ortaklık yapısı ve bağlı ortaklıklar', 'Hisseyi tutan fonlar: KAP PDR dizininden fon + ağırlık %', 'Hisseye özel KAP ve haber'] },
