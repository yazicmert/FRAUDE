...
const GUIDE: Record<'tr' | 'en', GuideContent> = {
  tr: {
    ...
    modules: [
      ...
      { code: 'CA', name: 'Kurumsal Olaylar', tag: 'Corporate', desc: 'Şirket aksiyonları ve halka arz takvimi.', items: ['Temettü kayıtları — KAP kar payı bildirimlerinden: pay grubu bazında brüt/net ve kesinleşen hak kullanım tarihi', 'Bedelli/bedelsiz sermaye artırımları — SPK bültenleri + KAP bildirimleri', 'Halka arz takvimi ve arşivi; fiyat, lot ve arz büyüklüğü SPK izahname onayından', 'Onay sonrası otomatik takip: katılımcı sayısı, ilk işlem tarihi, pazar ve endeks üyeliği KAP bildirimleri yayımlandıkça kendiliğinden dolar', 'Her satır kaynağını gösterir (SPK bülteni / KAP bildirimi)', 'Satış duyurusu (TSSD) okunur: arz fiyatı, talep toplama tarihleri ve satan ortakların adıyla pay yapısı — arz başlamadan önce, resmî belgeden', 'Halka arz detay kartı ekran genişliğine oturur; tablo yatay kaydırılsa da kart yerinde kalır', 'Tahsisat oranı, fon kullanımı ve pay yapısı yalnız kaynakta yazdığı gibi gösterilir — okunamayan alan uydurulmaz, kaynak metni görünür'] },
