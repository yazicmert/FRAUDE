...
/** Forum: iç içe iki konuşma balonu. */
export function ForumIcon({ size = 15 }: IconProps) {
  return (
    <svg {...svgProps(size)}>
      <path d="M8 13H5l-3 3V5a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v2" />
      <path d="M22 12a2 2 0 0 0-2-2h-9a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h8l3 3z" />
    </svg>
  );
}
...
/** Model Portföy (Çanta / Portföy). */
export function PortfolioIcon({ size = 15 }: IconProps) {
  return (
    <svg {...svgProps(size)}>
