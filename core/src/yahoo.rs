...
pub const BIST_TICKERS: &[(&str, &str)] = &[
    ...
    ("INVES", "INVESTCO HOLDİNG A.Ş."), ("ISATR", "TÜRKİYE İŞ BANKASI A.Ş."), ("ISBIR", "İŞBİR HOLDİNG A.Ş."), ("ISBTR", "TÜRKİYE İŞ BANKASI A.Ş."), ("ISCTR", "TÜRKİYE İŞ BANKASI A.Ş."), ("ISDMR", "İSKENDERUN DEMİR VE ÇELİK A.Ş."), 
