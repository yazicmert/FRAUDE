...
export default function SignIn() {
  ...
  const signInWithGitHub = async () => {
    ...
    // Başarıda tarayıcı GitHub'a yönlenir; buraya yalnız hata düşer
    if (oauthError) {
      setError(t('errSignIn') + oauthError.message);
      setBusy(false);
    }
  };
      ...
      <div className="card" style={{ textAlign: 'center', paddingTop: 34 }}>
        ...
        {mode !== 'forgot' && (
          <>
            ...
            <button className="btn" style={{ width: '100%' }} disabled={busy} onClick={() => void signInWithGitHub()}>
